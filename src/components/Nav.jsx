    ...
    >
      <div className=" shadow-lg flex bg-slate-500 rounded-full bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10   px-3 py-5 items-center justify-between  max-[320px]:gap-3 gap-12 md:gap-40 ">
        ...
        id="home-button"
          ...
          className=" font-eikomed  max-[425px]:text-[10px]  text-sm mx-2 sm:mx-10  cursor-pointer tracking-[0.15em]"
        >
          DEEPTHIMAI KANDULA
        </motion.div>
        <div className="flex items-center gap-2 sm:gap-5  mx-3 sm:mx-10">
          ...
          id="work-button"
            ...
            className="font-montrealmed  text-sm  max-[425px]:text-[10px] cursor-pointer"
          >
            Work
          </motion.div>
          <motion.a
            ...
            className=" font-montrealmed   text-sm  max-[425px]:text-[10px]"
          >
            Email Me
          </motion.a>
        </div>
